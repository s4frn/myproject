  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("RSSI", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
        actions: [
                ...
                axes: <RadialAxis>[
                  RadialAxis(
                    ...
                    pointers: <GaugePointer>[
                      NeedlePointer(value: double.tryParse(rssiValue) ?? 0),
                    ],
                    annotations: <GaugeAnnotation>[
                      GaugeAnnotation(
                        widget: Text("$rssiValue °C",
